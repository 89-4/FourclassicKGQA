...
@app.route('/get_all_honglou', methods=['GET', 'POST'])
def get_all_honglou():
    return render_template('all_honglou.html')


@app.route('/get_all_xiyou', methods=['GET', 'POST'])
def get_all_xiyou():
    return render_template('all_xiyou.html')


@app.route('/get_all_shuihu', methods=['GET', 'POST'])
def get_all_shuihu():
    return render_template('all_shuihu.html')
