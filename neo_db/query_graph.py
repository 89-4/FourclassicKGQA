...
#
# def query_shuihuzhuan(name):
#     data = graph.run(
#         "MATCH (p:Shuihuzhuan) - [r] -> (n)  RETURN "
#         "p.Name,r.relation, n.Name ,p.cate,n.cate; "
#     )
#
#     data = list(data)
#     print(get_json_data(data))
#     return get_json_data(data)
#
# def query_xiyouji(name):
#     data = graph.run(
#         "MATCH (p:Xiyouji) - [r] -> (n)  RETURN "
#         "p.Name,r.relation, n.Name ,p.cate,n.cate; "
#     )
#
#     data = list(data)
...
def get_json_data(data):
    ...
    for j in d:
        ...
        #data_item['category'] = CA_LIST_SHUIHUZHUAN[j_array[1]]
        #data_item['category'] = CA_LIST_HONHLOU[j_array[1]]
        data_item['category'] = CA_LIST[j_array[1]]
...
def get_KGQA_answer(array):
    ...
    with open("./spider/images/" + "东平王.jpg" , "rb") as image:
